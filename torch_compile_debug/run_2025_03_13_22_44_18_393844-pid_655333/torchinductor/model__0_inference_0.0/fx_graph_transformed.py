class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "Sym(s0)", arg1_1: "i32[s0]", arg2_1: "Sym(s1)", arg3_1: "Sym(s2)", arg4_1: "Sym(s3)", arg5_1: "Sym(s4)", arg6_1: "Sym(s5)"):
        ...
        bitwise_or: "b8[s0]" = torch.ops.aten.bitwise_or.Tensor(bitwise_and, bitwise_and_1)
        ...
        mul: "i64[s0]" = torch.ops.aten.mul.Tensor(bitwise_and, arg2_1);  bitwise_and = None
        ...
        sub_6: "Sym(-s1 + s2)" = arg3_1 - arg2_1;  arg3_1 = arg2_1 = None
        ...
        mul_2: "i64[s0]" = torch.ops.aten.mul.Tensor(bitwise_and_1, sub_8);  bitwise_and_1 = sub_8 = None
